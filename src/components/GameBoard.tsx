...
import {
  ...
  advanceToNextRound,
  changeOnlyTheme,
} from "@/services/gameService"; // ★ changeOnlyTheme を追加
...
export default function GameBoard({
  ...
  const handleThemeChange = async () => {
    ...
    try {
      ...
      // ★ 修正：advanceToNextRound ではなく changeOnlyTheme を呼び出す！
  ...
  // 6. 次のラウンドへ進む（ホストのみ・完全にリフレッシュして配り直す）
